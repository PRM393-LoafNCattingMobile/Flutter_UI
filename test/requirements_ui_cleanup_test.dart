...
void main() {
  test('AppStrings and AppRoutes expose the expected centralized values', () {
    ...
    expect(
      ...
      'Đơn hàng của Lan đã được gửi đến quán.',
    );
    expect(
  ...
  test('listed files no longer use raw named-route literals where prohibited',
    ...
    final splashFile = File('lib/features/auth/screens/splash_screen.dart');
    final loginFile = File('lib/features/auth/screens/login_screen.dart');
    final registerFile = File('lib/features/auth/screens/register_screen.dart');
    final profileFile =
