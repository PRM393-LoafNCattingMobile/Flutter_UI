...
import 'package:loafncatting_mobile/features/product/widgets/product_detail_widgets.dart';
...
class _ProductDetailScreenState extends State<ProductDetailScreen> {
        ...
        child: ListView(
          ...
          children: [
            ...
            ProductQuantitySelector(
              ...
              stockCount: product.unitInStock,
  ...
  Future<void> _addToCart(Product product) async {
    ...
    final message = switch (result.status) {
      CartAddStatus.added =>
        AppStrings.addedItemsToCartMessage(result.addedQuantity),
      CartAddStatus.stockLimit => AppStrings.cartStockLimitReachedMessage,
      CartAddStatus.authRequired => AppStrings.cartSessionExpiredMessage,
      CartAddStatus.syncFailed => AppStrings.cartSyncFailedMessage,
    };
